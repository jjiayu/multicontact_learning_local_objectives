...
UnseenStateFilePath = "/home/jiayu/Desktop/MLP_DataSet/"+UnseenStateFilePath[idxTemp:]
...
RollOutTrackingPath = "/home/jiayu/Desktop/MLP_DataSet/"+RollOutTrackingPath[idxTemp:]
...
viz.draw_timeSeries_and_traj(filePath = recompute_traj, query_traj = query_traj, traj_color = None, startStepNum = 0, EndStepNum = 29, NumLocalKonts = 8, fig= fig, ax = ax)
viz.draw_timeSeries_and_traj(filePath = NLP_traj_Path, query_traj = query_traj, traj_color = None, startStepNum = 0, EndStepNum = 29, NumLocalKonts = 8, fig= fig, ax = ax)
