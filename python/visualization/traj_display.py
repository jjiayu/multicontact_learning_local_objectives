...
def draw_timeSeries_and_traj(filePath=None, query_traj=None, traj_color=None, startStepNum=0, EndStepNum=14, NumLocalKonts=7, fig=None, ax=None):
    ...
    for roundIdx in range(len(OptResults)):
        ...
        xdot_traj = traj[Level1_VarIndex["xdot"]
                         [0]:Level1_VarIndex["xdot"][1]+1]
        ydot_traj = traj[Level1_VarIndex["ydot"]
                         [0]:Level1_VarIndex["ydot"][1]+1]
        zdot_traj = traj[Level1_VarIndex["zdot"]
                         [0]:Level1_VarIndex["zdot"][1]+1]
        ...
        Ldotx_traj = traj[Level1_VarIndex["Ldotx"]
                          [0]:Level1_VarIndex["Ldotx"][1]+1]
        Ldoty_traj = traj[Level1_VarIndex["Ldoty"]
                          [0]:Level1_VarIndex["Ldoty"][1]+1]
        Ldotz_traj = traj[Level1_VarIndex["Ldotz"]
                          [0]:Level1_VarIndex["Ldotz"][1]+1]

        FL1x_traj = traj[Level1_VarIndex["FL1x"]
                         [0]:Level1_VarIndex["FL1x"][1]+1]
        FL2x_traj = traj[Level1_VarIndex["FL2x"]
                         [0]:Level1_VarIndex["FL2x"][1]+1]
        FL3x_traj = traj[Level1_VarIndex["FL3x"]
                         [0]:Level1_VarIndex["FL3x"][1]+1]
        FL4x_traj = traj[Level1_VarIndex["FL4x"]
                         [0]:Level1_VarIndex["FL4x"][1]+1]

        FR1x_traj = traj[Level1_VarIndex["FR1x"]
                         [0]:Level1_VarIndex["FR1x"][1]+1]
        FR2x_traj = traj[Level1_VarIndex["FR2x"]
                         [0]:Level1_VarIndex["FR2x"][1]+1]
        FR3x_traj = traj[Level1_VarIndex["FR3x"]
                         [0]:Level1_VarIndex["FR3x"][1]+1]
        FR4x_traj = traj[Level1_VarIndex["FR4x"]
                         [0]:Level1_VarIndex["FR4x"][1]+1]

        FL1y_traj = traj[Level1_VarIndex["FL1y"]
                         [0]:Level1_VarIndex["FL1y"][1]+1]
        FL2y_traj = traj[Level1_VarIndex["FL2y"]
                         [0]:Level1_VarIndex["FL2y"][1]+1]
        FL3y_traj = traj[Level1_VarIndex["FL3y"]
                         [0]:Level1_VarIndex["FL3y"][1]+1]
        FL4y_traj = traj[Level1_VarIndex["FL4y"]
                         [0]:Level1_VarIndex["FL4y"][1]+1]

        FR1y_traj = traj[Level1_VarIndex["FR1y"]
                         [0]:Level1_VarIndex["FR1y"][1]+1]
        FR2y_traj = traj[Level1_VarIndex["FR2y"]
                         [0]:Level1_VarIndex["FR2y"][1]+1]
        FR3y_traj = traj[Level1_VarIndex["FR3y"]
                         [0]:Level1_VarIndex["FR3y"][1]+1]
        FR4y_traj = traj[Level1_VarIndex["FR4y"]
                         [0]:Level1_VarIndex["FR4y"][1]+1]

        FL1z_traj = traj[Level1_VarIndex["FL1z"]
                         [0]:Level1_VarIndex["FL1z"][1]+1]
        FL2z_traj = traj[Level1_VarIndex["FL2z"]
                         [0]:Level1_VarIndex["FL2z"][1]+1]
        FL3z_traj = traj[Level1_VarIndex["FL3z"]
                         [0]:Level1_VarIndex["FL3z"][1]+1]
        FL4z_traj = traj[Level1_VarIndex["FL4z"]
                         [0]:Level1_VarIndex["FL4z"][1]+1]

        FR1z_traj = traj[Level1_VarIndex["FR1z"]
                         [0]:Level1_VarIndex["FR1z"][1]+1]
        FR2z_traj = traj[Level1_VarIndex["FR2z"]
                         [0]:Level1_VarIndex["FR2z"][1]+1]
        FR3z_traj = traj[Level1_VarIndex["FR3z"]
                         [0]:Level1_VarIndex["FR3z"][1]+1]
        FR4z_traj = traj[Level1_VarIndex["FR4z"]
                         [0]:Level1_VarIndex["FR4z"][1]+1]
        ...
        timeline = np.concatenate((time_offset+Phase1_TimeSeries, time_offset +
                                  Phase2_TimeSeries[1:], time_offset+Phase3_TimeSeries[1:]), axis=None)
        time_offset = time_offset+Phase3_TimeSeries[-1]

        Phase1_x = x_traj[0:NumLocalKonts+1]
        Phase2_x = x_traj[NumLocalKonts:2*NumLocalKonts+1]
        Phase3_x = x_traj[2*NumLocalKonts:]
        Phase1_y = y_traj[0:NumLocalKonts+1]
        Phase2_y = y_traj[NumLocalKonts:2*NumLocalKonts+1]
        Phase3_y = y_traj[2*NumLocalKonts:]
        Phase1_z = z_traj[0:NumLocalKonts+1]
        Phase2_z = z_traj[NumLocalKonts:2*NumLocalKonts+1]
        Phase3_z = z_traj[2*NumLocalKonts:]

        Phase1_xdot = xdot_traj[0:NumLocalKonts+1]
        Phase2_xdot = xdot_traj[NumLocalKonts:2*NumLocalKonts+1]
        Phase3_xdot = xdot_traj[2*NumLocalKonts:]
        Phase1_ydot = ydot_traj[0:NumLocalKonts+1]
        Phase2_ydot = ydot_traj[NumLocalKonts:2*NumLocalKonts+1]
        Phase3_ydot = ydot_traj[2*NumLocalKonts:]
        Phase1_zdot = zdot_traj[0:NumLocalKonts+1]
        Phase2_zdot = zdot_traj[NumLocalKonts:2*NumLocalKonts+1]
        Phase3_zdot = zdot_traj[2*NumLocalKonts:]

        Phase1_Lx = Lx_traj[0:NumLocalKonts+1]
        Phase2_Lx = Lx_traj[NumLocalKonts:2*NumLocalKonts+1]
        Phase3_Lx = Lx_traj[2*NumLocalKonts:]
        Phase1_Ly = Ly_traj[0:NumLocalKonts+1]
        Phase2_Ly = Ly_traj[NumLocalKonts:2*NumLocalKonts+1]
        Phase3_Ly = Ly_traj[2*NumLocalKonts:]
        Phase1_Lz = Lz_traj[0:NumLocalKonts+1]
        Phase2_Lz = Lz_traj[NumLocalKonts:2*NumLocalKonts+1]
        Phase3_Lz = Lz_traj[2*NumLocalKonts:]

        Phase1_Ldotx = Ldotx_traj[0:NumLocalKonts+1]
        Phase2_Ldotx = Ldotx_traj[NumLocalKonts:2*NumLocalKonts+1]
        Phase3_Ldotx = Ldotx_traj[2*NumLocalKonts:]
        Phase1_Ldoty = Ldoty_traj[0:NumLocalKonts+1]
        Phase2_Ldoty = Ldoty_traj[NumLocalKonts:2*NumLocalKonts+1]
        Phase3_Ldoty = Ldoty_traj[2*NumLocalKonts:]
        Phase1_Ldotz = Ldotz_traj[0:NumLocalKonts+1]
        Phase2_Ldotz = Ldotz_traj[NumLocalKonts:2*NumLocalKonts+1]
        Phase3_Ldotz = Ldotz_traj[2*NumLocalKonts:]
        ...
        TSIDTrajectory["Landing_P"] = list(
            np.concatenate((px_res, py_res, pz_res), axis=None))
        ...
        if traj_idx % 2 == 0:
            if traj_idx == 0:
                if traj_idx <= len(Traj_Collected["x_result"])-1:
                    ax.plot(Traj_Collected["timeseries"][traj_idx], Traj_Collected[query_traj]
                            [traj_idx], color=traj_color, label=filePath[-19:], linestyle='dashed')
            else:
                if traj_idx <= len(Traj_Collected["x_result"])-1:
                    ax.plot(Traj_Collected["timeseries"][traj_idx], Traj_Collected[query_traj]
                            [traj_idx], color=traj_color, linestyle='dashed')
        else:
            if traj_idx <= len(Traj_Collected["x_result"])-1:
                ax.plot(Traj_Collected["timeseries"][traj_idx],
                        Traj_Collected[query_traj][traj_idx], color=traj_color)
