...
#GroupName=Group20 && longjob -28day -c "nice bash server_rollout_for_large_slope.sh LargeSlope_2steps RollOuts_LargeSlope_20Steps_Start13_Large5_2Steps LargeSlope_Start13_Large5 $GroupName $GroupName 20 2"
