...
#GroupName=Group1 && bash desktop_rollout_compute_from_existing_terrain.sh Rubbles_2StepNLP RollOut2StepNLP_All CleanTrainingSetRollOuts_All $GroupName $GroupName 30 2 No
