...
#GroupName=Group20 && longjob -28day -c "nice bash sever_re_rollout_from_exist_env_with_nlp.sh LargeSlope_Angle_17_26 ReRollOuts_LargeSlope_20Steps_Start15_Large5_2Steps Clean_RollOuts_LargeSlope_20Steps_Start15_Large5_4Steps $GroupName $GroupName 20 2"
