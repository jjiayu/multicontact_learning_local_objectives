...
#GroupName=Group1 && bash Desktop_NN_trackExp_LargeSlope_StartwithLookUp_TrainingSet_SameGroupPrefix.sh Testing_Largeslope_TimeTrack_Angle_17_26 NN_TrackTestAll_LargeSlope CleanValidationRollOut $GroupName $GroupName /home/jiayu/Desktop/MLP_DataSet/Testing_Largeslope_TimeTrack_Angle_17_26/ML_Models/NN_Model_Aug_3Time_EarlyEarlyStopping 8 2
