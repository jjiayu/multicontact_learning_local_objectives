...
#$5 --- The path of DataSet Folder (i.e. /home/jiayu/Desktop/MLP_DataSet/Rubbles/DataSet)

#Command Example (On server):
#longjob -28day -c "nice bash server_kNN_trackExp_TrainingSet_All.sh Rubbles kNN_TrackingExp_LargeTrainingSet CleanTrainingSetRollOuts_Large Group1 /afs/inf.ed.ac.uk/user/s15/s1545529/Desktop/datastorage/Rubbles/DataSet_LargeTrainingSet/"
#---------------------
