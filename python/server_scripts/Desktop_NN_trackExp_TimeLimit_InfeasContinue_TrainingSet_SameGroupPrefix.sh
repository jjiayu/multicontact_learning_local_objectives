...
#GroupName=Group12 && bash Desktop_NN_trackExp_TimeLimit_InfeasContinue_TrainingSet_SameGroupPrefix.sh Rubbles_Add2Steps_1StepbeforeFail_TimeLimit_ContinuewithInfeas NN_TrackTrainingAll_Add2Steps_1StepbeforeFail_2Time_RemovebyClip CleanTrainingSetRollOuts_All $GroupName $GroupName /afs/inf.ed.ac.uk/user/s15/s1545529/Desktop/datastorage/Rubbles_Add2Steps_1StepbeforeFail_TimeStats/ML_Models/NN_Model_Aug2Steps_2Time_RemoveOutlier
