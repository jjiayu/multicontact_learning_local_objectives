...
#longjob -28day -c "nice bash server_LookUp_trackExp_TrainingSet_All.sh Rubbles LookUp_TrackingExp_LargeTrainingSet CleanTrainingSetRollOuts_Large Group1 0.0"
#---------------------
