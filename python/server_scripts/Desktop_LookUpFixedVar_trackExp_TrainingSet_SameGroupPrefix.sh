...
#GroupName=Group1 && bash Desktop_LookUpFixedVar_trackExp_TrainingSet_SameGroupPrefix.sh LookUp_LargeSlope_Angle_21_26 LookUp_Tracking_NoFixing CleanRollOuts_LargeSlope_20Steps_Start12_Large5_Angle21_26_2Steps $GroupName $GroupName 0.0 None

#GroupName=Group1 && bash Desktop_LookUpFixedVar_trackExp_TrainingSet_SameGroupPrefix.sh LargeSlope_Angle_23_X_negative LookUp_Tracking_2Steps_NoFixing Clean_RollOuts_LargeSlope_Start12_Large5_X_negative_Angle23_2Steps $GroupName $GroupName 0.0 None

#GroupName=Group1 && bash Desktop_LookUpFixedVar_trackExp_TrainingSet_SameGroupPrefix.sh LookUp_LargeSlope_Angle_17_21 LookUp_Tracking_NoFixing Clean_RollOuts_LargeSlope_20Steps_Start12_Large5_Angle_17_21_2Steps $GroupName $GroupName 0.0 None
