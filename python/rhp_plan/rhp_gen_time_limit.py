...
for roundNum in range(Nrounds):
    ...
    if (solverStats["success"] == True) or (solverStats["success"] == False and solverStats["return_status"] == "KTR_RC_TIME_LIMIT_FEAS"):
    ...
    elif solverStats["success"] == False and not (solverStats["return_status"] == "KTR_RC_TIME_LIMIT_FEAS"):
