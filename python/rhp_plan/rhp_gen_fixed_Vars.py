...
print("- Fixed Surf Incliation (degrees): ", TerrainSettings["fixed_inclination"]/np.pi*180) if TerrainSettings["fixed_inclination"] != None else print("- Random Surf Inclination")
...
for roundNum in range(Nrounds):
    ...
    #Get Fixed Variables by fixing the Var Bounds
    single_opt_res = LoadTerrainModel["SingleOptResultSavings"][roundNum]
    #   Get fixed variables for the first level
    decision_var_index_level1 = single_opt_res["var_idx"]["Level1_Var_Index"]
    px_lv1_fixed = single_opt_res["opt_res"][decision_var_index_level1["px"][0]:decision_var_index_level1["px"][1]+1]
    py_lv1_fixed = single_opt_res["opt_res"][decision_var_index_level1["py"][0]:decision_var_index_level1["py"][1]+1]
    pz_lv1_fixed = single_opt_res["opt_res"][decision_var_index_level1["pz"][0]:decision_var_index_level1["pz"][1]+1]

    timing_lv1_fixed = single_opt_res["opt_res"][decision_var_index_level1["Ts"][0]:decision_var_index_level1["Ts"][1]+1]

    #   Get fixed variables for the first level
    if NumLookAhead > 1:

        decision_var_index_level2 = single_opt_res["var_idx"]["Level2_Var_Index"]
        x_opt_level2 = single_opt_res["opt_res"][decision_var_index_level1["Ts"][1]+1:]
        px_lv2_fixed = x_opt_level2[decision_var_index_level2["px"][0]:decision_var_index_level2["px"][1]+1]
        py_lv2_fixed = x_opt_level2[decision_var_index_level2["py"][0]:decision_var_index_level2["py"][1]+1]
        pz_lv2_fixed = x_opt_level2[decision_var_index_level2["pz"][0]:decision_var_index_level2["pz"][1]+1]
        timing_lv2_fixed = x_opt_level2[decision_var_index_level2["Ts"][0]:decision_var_index_level2["Ts"][1]+1]
    
    #Nothing to fix
    if ExternalParameters["Fixing_Vars"] == "None":
        print("Fixed Variables")
    
    #Fix Contct Location
    if "Step" in ExternalParameters["Fixing_Vars"]:
        print("Fixing FootSteps")
        #For lv1
        #px
        DecisionVars_lb[decision_var_index_level1["px"][0]:decision_var_index_level1["px"][1]+1] = px_lv1_fixed
        DecisionVars_ub[decision_var_index_level1["px"][0]:decision_var_index_level1["px"][1]+1] = px_lv1_fixed
        #py
        DecisionVars_lb[decision_var_index_level1["py"][0]:decision_var_index_level1["py"][1]+1] = py_lv1_fixed
        DecisionVars_ub[decision_var_index_level1["py"][0]:decision_var_index_level1["py"][1]+1] = py_lv1_fixed
        #pz
        DecisionVars_lb[decision_var_index_level1["pz"][0]:decision_var_index_level1["pz"][1]+1] = pz_lv1_fixed
        DecisionVars_ub[decision_var_index_level1["pz"][0]:decision_var_index_level1["pz"][1]+1] = pz_lv1_fixed
        ...
        if NumLookAhead > 1:
            ...
            #px
            DecisionVars_lb[decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["px"][0]:decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["px"][1]+1] = px_lv2_fixed
            DecisionVars_ub[decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["px"][0]:decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["px"][1]+1] = px_lv2_fixed

            #py
            DecisionVars_lb[decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["py"][0]:decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["py"][1]+1] = py_lv2_fixed
            DecisionVars_ub[decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["py"][0]:decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["py"][1]+1] = py_lv2_fixed

            #pz
            DecisionVars_lb[decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["pz"][0]:decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["pz"][1]+1] = pz_lv2_fixed
            DecisionVars_ub[decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["pz"][0]:decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["pz"][1]+1] = pz_lv2_fixed

    #Fix Contact Timing
    if "Timing" in ExternalParameters["Fixing_Vars"]:
        print("Fixing Contact Timings")
        #For lv1
        DecisionVars_lb[decision_var_index_level1["Ts"][0]:decision_var_index_level1["Ts"][1]+1] = timing_lv1_fixed
        DecisionVars_ub[decision_var_index_level1["Ts"][0]:decision_var_index_level1["Ts"][1]+1] = timing_lv1_fixed

        #For the second level
        if NumLookAhead > 1:
            DecisionVars_lb[decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["Ts"][0]:decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["Ts"][1]+1] = timing_lv2_fixed
            DecisionVars_ub[decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["Ts"][0]:decision_var_index_level1["Ts"][1]+1+decision_var_index_level2["Ts"][1]+1] = timing_lv2_fixed
    
    if not(ExternalParameters["Fixing_Vars"] == "None" or ExternalParameters["Fixing_Vars"] == "Step" or ExternalParameters["Fixing_Vars"] == "Timing" or ExternalParameters["Fixing_Vars"] == "StepTiming"):
        raise Exception("Unknown Fixing Var Mode")
