...
ExternalParameters = {"WorkingDirectory": None,
                      ...
                      "TerrainChangeCyleIndex": 8-1, #3 #the actual cycle we want to change terrain then minus 1 (problematic design before), so before that cycle (include that cycle), terrain remain unchanged
...
if TerrainModelPath == None:
    ...
    if ExternalParameters["TerrainMoveToOdom"] == "Yes":
        if ExternalParameters["Changing_Env_Flag"] == "No":
            ...
            TerrainInfo_before_change = terrain_model_gen_lab_inner_blocks(terrain_name    = TerrainSettings["terrain_type"],  
                                            ...
                                            x_offset = x_offset)
            #changed terrain
            TerrainSettings_after_change = LoadTerrainModel["TerrainSettings"]
