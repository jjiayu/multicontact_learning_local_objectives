...
viz.DisplayResults_Not_Show(TerrainModel=TrackingExp_data["TerrainInfo"], SingleOptResult=None,
                            AllOptResult=TrackingExp_data["SingleOptResultSavings"], fig=fig, ax=ax)
