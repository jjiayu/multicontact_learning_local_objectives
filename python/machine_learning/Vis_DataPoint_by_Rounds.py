...
print("Contact Location Representation Type: ",dataset_original["Contact_Representation_Type"])
...
X_original = dataset_original["input"];       y_original = dataset_original["output"]
#print(X.max(axis=0))
#print(X.min(axis=0))
...
ax.scatter(X_Round_1[:,0], X_Round_1[:,1], X_Round_1[:,2], c='g', marker='o', linewidth = 0.1, alpha=0.025) 
ax.scatter(X_Round_2[:,0], X_Round_2[:,1], X_Round_2[:,2], c='r', marker='o', linewidth = 0.1, alpha=0.025) 
ax.scatter(X_Round_3[:,0], X_Round_3[:,1], X_Round_3[:,2], c='b', marker='o', linewidth = 0.1, alpha=0.025) 
ax.scatter(X_Round_4[:,0], X_Round_4[:,1], X_Round_3[:,2], c='g', marker='o', linewidth = 0.1, alpha=0.025) 
ax.scatter(X_Round_5[:,0], X_Round_5[:,1], X_Round_5[:,2], c='y', marker='o', linewidth = 0.1, alpha=0.025) 
