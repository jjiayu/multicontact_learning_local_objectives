...
ax.scatter(principalComponents[:,0], principalComponents[:,1], principalComponents[:,2], marker='o', linewidth = 0.001, color = 'b', alpha=0.0025) 
plt.show()
...
fig=plt.figure();   ax = Axes3D(fig) 
ax.scatter(principalComponents[:,0], principalComponents[:,1], principalComponents[:,2], marker='o', linewidth = 0.001, color = 'b', alpha=0.0025) 
ax.scatter(principalComponents_aug[:,0], principalComponents_aug[:,1], principalComponents_aug[:,2], marker='o', linewidth = 0.001, color = 'g', alpha=0.0025) 
plt.show()