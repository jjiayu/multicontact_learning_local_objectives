...
print("The folder where stores the Terrain/ground-truth local obj for tracking the first few rounds: ", TerrainModel_Folder_Name)

#   Define the folder where we get the large slope tracking result
LargeSlope_TrackingFolder_Name = sys.argv[3]
print("The folder where stores the Terrain/ground-truth local obj for tracking the first few rounds: ", LargeSlope_TrackingFolder_Name)
...
NN_track_largslope_file_path = workingDirectory + '/' + LargeSlope_TrackingFolder_Name + '/' + NN_track_largslope_filename
...
TerrainModelFileName_Idx = NN_track_largslope_data["TerrainModelPath"].find("/Group")
TerrainModelFilePath = TerrainModel_Folder_Path + NN_track_largslope_data["TerrainModelPath"][TerrainModelFileName_Idx:]
...
PartialTerrainFileName_Idx = TerrainModelFile_data["TerrainModelPath"].find("LargeSlopeTerrain")
PartialTerrainFilePath = workingDirectory + '/' + TerrainModelFile_data["TerrainModelPath"][PartialTerrainFileName_Idx:]
...
Rubbles_FileName_Idx = PartialTerrain_data["Rubbles_RollOut_filepath"].find("/Group")
Rubbles_FilePath = workingDirectory + '/' + Rubbles_Folder_Name + '/' + PartialTerrain_data["Rubbles_RollOut_filepath"][Rubbles_FileName_Idx:]
...
ConnectedData["TerrainModel"] = Rubbles_data["TerrainModel"][0:StepIdx_whereLargeSlopeTerrainStarts] + NN_track_largslope_data["TerrainModel"]
ConnectedData["CasadiParameters"] = Rubbles_data["CasadiParameters"][0:StepIdx_whereLargeSlopeTerrainStarts] +  NN_track_largslope_data["CasadiParameters"]
ConnectedData["SingleOptResultSavings"] = Rubbles_data["SingleOptResultSavings"][0:StepIdx_whereLargeSlopeTerrainStarts] +  NN_track_largslope_data["SingleOptResultSavings"]
ConnectedData["Trajectory_of_All_Rounds"] = Rubbles_data["Trajectory_of_All_Rounds"][0:StepIdx_whereLargeSlopeTerrainStarts] +  NN_track_largslope_data["Trajectory_of_All_Rounds"]
ConnectedData["Num_of_Rounds"] = len(Rubbles_data["SingleOptResultSavings"][0:StepIdx_whereLargeSlopeTerrainStarts]) + len(NN_track_largslope_data["SingleOptResultSavings"])

pickle.dump(ConnectedData, open(workingDirectory + '/' + 'testtest'+ ".p", "wb"))