...
# i.e. "/home/jiayu/Desktop/multicontact_learning_local_objectives/data/large_slope_flat_patches/"
...
for filename in filenames:
    if ".p" in filename:  # a data file
        ...
        if not (len(data["SingleOptResultSavings"]) == data["Num_of_Rounds"]):
            # The last failed round is not saved, therefore the length of SingleOptResultSavings is the failed index
            failedIndex.append(len(data["SingleOptResultSavings"]))
