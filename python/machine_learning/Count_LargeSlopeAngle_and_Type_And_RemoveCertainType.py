...
for filename in filenames:
    if ".p" in filename:  # a data file
        ...
        rotationangle = np.absolute(
            getTerrainRotationAngle(terrain_model[large_slope_idx+2]))
        ...
        if rotationtype == removeType:
            print("Failed File --- Delete, bnecasue type, ",
                  rotationtype, "and we want to remove ", removeType)
