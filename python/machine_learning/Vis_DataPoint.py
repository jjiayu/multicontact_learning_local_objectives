...
X_aug      = dataset_aug["input"];            y_aug      = dataset_aug["output"]
X_failed   = dataset_failed_state["input"];   y_failed   = dataset_failed_state["output"]
X_new      = dataset_new["input"];            y_new      = dataset_new["output"]
#print(X.max(axis=0))
#print(X.min(axis=0))
